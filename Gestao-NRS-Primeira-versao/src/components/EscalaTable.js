        ...
        turnosOrdenados.forEach((turnoNome, index) => {
            ...
            if (analistasNoTurno > 0) {
                ...
                if (index < turnosOrdenados.length - 1) {
                 ...
                 tableRows.push(
                    <tr key={turnoNome}>
                        <td className="turno" style={{ backgroundColor: turnosAtivos[turnoNome]?.cor || 'var(--btn-primary-bg)' }}>{turnoNome}</td>
                        <td className="analista" style={{ backgroundColor: turnosAtivos[turnoNome]?.cor || 'var(--btn-primary-bg)' }}>(Nenhum analista)</td>
