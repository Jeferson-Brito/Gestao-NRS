...
const App = () => {
    ...
    const handleLogin = async (userData) => {
        ...
        showToastMessage(`Olá, ${userData.username}! Login realizado com sucesso.`, 'fa-check');
    ...
    if (!user) {
        return (
            <>
                <Login onLogin={handleLogin} onForgotPassword={() => setIsForgotPasswordModalOpen(true)} showToastMessage={showToastMessage} />
